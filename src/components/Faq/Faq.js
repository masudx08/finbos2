    ...
    <div>
       <section class="faq" id="faq">
                <div class="container">
                    ...
                    <div class="faq-wrapper tabs-block f-jcsb">
                        <ul class="faq-list tabs-link">
                            <li class="faq-list__item">
                                <a href="#tab-1" class="faq-list__link f-center-jcsb">
                                    <div class="faq-list__title">
                                        How safe is it?
                                    </div>
                                    <span class="faq-list__plus">
                                        
                                    </span>
                                </a>
                            </li>
                            <li class="faq-list__item">
                                <a href="#tab-2" class="faq-list__link f-center-jcsb">
                                    <div class="faq-list__title">
                                        How does it work?
                                    </div>
                                    <span class="faq-list__plus">
                            ...
                            <li class="faq-list__item">
                                <a href="#tab-3" class="faq-list__link f-center-jcsb">
                                    <div class="faq-list__title">
                                        How to connect?
                                    </div>
                                    <span class="faq-list__plus">
                            ...
                            <li class="faq-list__item">
                                <a href="#tab-4" class="faq-list__link f-center-jcsb">
                                    <div class="faq-list__title">
                            ...
                            <li class="faq-list__item">
                                <a href="#tab-5" class="faq-list__link f-center-jcsb">
                                    <div class="faq-list__title">
                            ...
                            <li class="faq-list__item">
                                <a href="#tab-6" class="faq-list__link f-center-jcsb">
                                    <div class="faq-list__title">
                        ...
                        <div class="faq-block">
                            <div class="faq-content tabs-content" id="tab-1">
                                ...
                                {/* <!-- <a href="#" class="faq-content__btn main-btn main-btn_blue f-center-center">
                            ...
                            <div class="faq-content tabs-content" id="tab-2">
                                <h3 class="faq-content__title">
                                    How does it work?
                                </h3>
                                <p class="faq-content__text">
                            ...
                            <div class="faq-content tabs-content" id="tab-3">
                                <h3 class="faq-content__title">
                                    How to connect?
                                </h3>
                                <p class="faq-content__text">
                            ...
                            <div class="faq-content tabs-content" id="tab-4">
                                <h3 class="faq-content__title">
                                    What is the minimum and maximum deposit?
                                </h3>
                                <p class="faq-content__text">
                            ...
                            <div class="faq-content tabs-content" id="tab-5">
                                <h3 class="faq-content__title">
                                    How does withdrawal work?
                                </h3>
                                <p class="faq-content__text">
                            ...
                            <div class="faq-content tabs-content" id="tab-6">
                                <h3 class="faq-content__title">
                                    How does the Affiliate Program work? 
                                </h3>
                                <p class="faq-content__text">
                    ...
                    <div class="faq-circle rotate-circle">
